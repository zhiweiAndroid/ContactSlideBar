...
public class SortAdapter extends BaseAdapter implements SectionIndexer{
	...
	public View getView(final int position, View view, ViewGroup arg2) {
		...
		if (view == null) {
			...
			viewHolder.tvName = (ImageTextView) view.findViewById(R.id.icon);
			viewHolder.tvNumber = (TextView) view.findViewById(R.id.title);
	...
	//	viewHolder.icon.setIconText(mContext,this.list.get(position).getNumber());
		return view;
